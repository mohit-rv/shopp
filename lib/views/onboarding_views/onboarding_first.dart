...
import '../../controller/onboarding_first.dart';
...
class _OnBoardingViewFirstState extends State<OnBoardingViewFirst> {
  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder(
      init: OnBoardingFirstController(),
      builder: (controller) {
        return Scaffold(
            ...
            child: Column(
              children: [
                Padding(
                  ...
                  child: Image.asset(
                    'assets/images/onboarding1.png', // Make sure this asset is available
                    height: heightSize / 2,
                  ),
                ),
                Expanded(
                            ...
                            child: Align(
                              ...
                              child: SizedBox(
                                ...
                                child: FloatingActionButton(
                                  onPressed: () {
                                    Get.toNamed(onBoarding2Screen);
                                  },
                                  backgroundColor: AppColors.whiteColor,
                                  elevation: 0,
                                  child: Image.asset(
                                    'assets/images/forword_arrow.png',
                                    height: 100,
                                    width: 100,
                                  ),
                                ),
